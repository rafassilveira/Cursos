...
console.log(text.replace(/Manuel Marques de Sousa/g, 'Rafael dos Santos Silveira'  ));
/*
...
console.log(text.replace(/brasileiro/g, 'manezinho'  ));
...
console.log("O Centauro de Luvas".replace(/(\w)/g, function (
        capturaTotal, frase) {  
    //Não necessidade de usar o parametro capturaToral, pois nao esta sendo usado captura '()'
...
*/
 ...
 function getMonthNumber(monthName) {
   ...
   };//fim da function getMonthNumber
...
*/
console.log('\nReplace de datas:');
function replaceDate(total, dia, mes, ano) {
